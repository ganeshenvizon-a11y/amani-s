  ...
  return (
    <section className="stories-philosophy" aria-labelledby="philosophy-title">
      <div className="stories-container stories-philosophy__grid">
        <Reveal className="stories-philosophy__label"><p className="stories-eyebrow">Our philosophy / 02</p><p className="stories-philosophy__small">Good food is only the beginning.</p></Reveal>
